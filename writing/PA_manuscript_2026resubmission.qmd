...
Finally, since *ML4P* does not record unique events, we ask how it relates to a well-known event count dataset. We assess *ML4P's* capacity to measure the importance of protests in a way that is distinctive from ACLED's protest event data. To do so, we sum ACLED protest events by month and compare them to our monthly measure of protest salience. See Appendix G for more details on the comparison of the 7,219 country-month. The two correlate only moderately within countries (median 0.39), and only about a third of the country-months either flags as unusually high are common to the two. The divergence is systematic and clusters around two sets of causes. First, *ML4P* rises without a rise in ACLED counts when a single large mobilization dominates the news. For example, Pakistan’s August, 2014 protests fall in the 7th percentile of its ACLED distribution but is the single highest month in *ML4P*. That month saw the culmination of the longest sit-in in Pakistani political history with hundreds of thousands of participants in Islamabad alone. Second and conversely, ACLED counts increase without a rise in *ML4P* when many small, dispersed gatherings occur, or when another story dominates the agenda. The two sources measure different quantities: ACLED how many protests occurred, while *ML4P* measures how much they mattered for civic space.[^10] Which dataset is more appropriate depends on the research question. 

[^10]: ACLED provides data on protests' sizes which would speak to salience, but it is missing for the vast majority of protests in the 7,219 country-months that overlap with *ML4P*.   

# 5. Use Case: Forecasting Coflict and Travel Advisory Onsets with ML4P {#sec-usecase}

We demonstrate *ML4P's* practical utility by showing that its high-frequency civic space salience measures improve forecasting of two consequential geopolitical outcomes: the onset of armed conflict and the issuance of U.S. Department of State (DOS) high-level travel advisories (HLTAs)---independent security assessments that serve as official risk benchmarks and drive critical operational responses including embassy closures and staff relocations. For conflict onset, we benchmark *ML4P* directly against ACLED. Both exercises provide further evidence that *ML4P* captures meaningful underlying political conditions rather than reporting noise.[^11]

[^11]: Consult Appendix H and @hlta2025report for further details on the data and models.

For the first forecasting exercise, we use conflict onset from the UCDP/PRIO Armed Conflict Dataset (v24.1) as the target variable. We use *ML4P's* monthly civic salience measures across all 20 categories and a series of economic and country-specific controls to train a LightGBM gradient boosted tree model providing forecasts for 3- and 6-month horizons, and repeat the process substituting the *ML4P's* with ACLED's 6 event types, aggregated to the country-month level. Both sets of models perform comparably well (see Appendix G Table 7). What distinguishes them is what drives the predictions. While the ACLED model relies on protests, battles, and strategic developments, which are overt events that largely restate that violence precedes more violence, *ML4P* draws on upstream civic-space dynamics: security mobilizations, activism surges, censorship, and arrests that capture escalating political tension and government repression strategies before violence erupts. These signals offer earlier warning and substantive insight into civic precursors that event-count data structurally cannot provide (see Appendix G, Figures 10 and 11).

For forecasting HLTAs, we construct a monthly panel of 60 developing countries from 2012 through 2023, modeling the onset of Level 3 ("Reconsider Travel") and Level 4 ("Do Not Travel") advisories scraped from the DOS website and supplemented with the Wayback Machine. HLTA onsets occur in only 1.42% of country-months, making this a demanding rare-event target. We employ the same data---including all 20 *ML4P* categories---and modeling strategy as before. The models achieve strong performance at both forecast horizons, with precision-recall improving markedly when predictions are evaluated within a ±1-month window of onset (see Appendix H, Table 8). Feature importance mirrors the conflict onset results in revealing early-warning dynamics. At 3 months, martial law in the preceding two months is the strongest predictor, with election irregularities and protest as secondary signals; at 6 months, election-related activity approximately 14 months before onset leads, followed by martial law and censorship (Appendix G, Figure 12). The prominence of electoral activity reflects the fact contested elections (and the repression of opponents, civil society, and the press that usually follows) increase political risk well before an HLTA is issued.


<!-- Version before Diego's August 7 2026 edits
