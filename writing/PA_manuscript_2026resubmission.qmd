  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        \AtBeginEnvironment{abstract}{\vspace{-0.75\baselineskip}}
...
[^4]: Paywalls are rare among *HQMARC's* domestic outlets and do not affect source selection, as we rely only on publicly accessible article openings (see the next section).
...
[^10]: ACLED provides data on the size of protests which would speak to salience, but it is missing for the vast majority of protests in the 7219 country-months that overlap with *ML4P*.   
